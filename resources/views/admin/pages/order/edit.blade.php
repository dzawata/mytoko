...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6">
                <form id="form-update" data-action="{{ route('update-order', $order->id) }}" data-page-url="{{ route('orders') }}">
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input class="form-control datepicker" type="text" name="tanggal" autocomplete="off" value="{{ $order->tanggal }}">
