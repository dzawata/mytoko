...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6">
                <form id="form-create-role" data-action="{{ route('update-role', $role->id) }}" data-page-url="{{ route('roles') }}">
                    <div class="form-group">
                        <label>Role</label>
                        <input class="form-control" type="text" name="role" autocomplete="off" value="{{ $role->name }}">
                        <p class="help-block help-block-role"></p>
                    </div>

                    <div class="form-group">
                        <label>Permissions</label>
                        <select id="permissions" name="permissions" data-value="{{ $role->hasPermissions }}" multiple>
...
<script>
    ...
    displaySelect.set(jQuery("#permissions").data('value'));
